from notification.notifier.base_notifier import BaseNotifier
...
class Notifier(BaseNotifier):
    ...
    notifier_settings = [
        {
            "key": "address",
            "label": "Email Address",
            "widget": '<input type="email" class="form-control" name="{key}" '
                      'id="{key}" placeholder="Email" value="{value}">'
        }
    ]
    ...
    def notify(self, notification):
        ...
        try:
            SUBJECT = "Openduty Incident Report - {0}".format(
